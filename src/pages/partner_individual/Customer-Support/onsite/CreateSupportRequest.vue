        ...
        <form @submit.prevent="createTicket">
          ...
          <div v-if="currentStep === 2" class="space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div>
                <label class="block text-sm font-semibold text-gray-700 mb-3">Issue Type <span class="text-rose-500">*</span></label>
                <select v-model="ticketForm.issue_type" required
                  class="w-full px-5 py-4 border-2 border-purple-200 rounded-2xl focus:ring-4 focus:ring-purple-300 focus:border-purple-500 transition-all bg-purple-50/50">
