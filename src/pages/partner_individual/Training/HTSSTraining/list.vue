<template>
  <div class="px-0 bg-white py-5 w-3/4 mx-auto">
    <div class="bg-teal-700 rounded-t-2xl text-white px-6 py-4">
      <h1 class="text-2xl font-semibold"> Training Lists</h1>
    </div>
        ...
        <table class="table table-zebra w-full">
          <thead>
            <tr class="bg-teal-50 text-teal-900">
              ...
              <th class="p-2 border-e text-left">Industry</th>
              <th class="p-2 border-e text-left">Solution</th>
              <th class="p-2 border-e text-left">Software</th>
              <th class="p-2 border-e text-left">Training Level</th>
              <th class="p-2 border-e text-left">Description</th>
              <th class="p-2 border-e text-left">Training Content Available Date</th>
              <th class="p-2 border-e text-left">Training Approval Status</th>
              <th class="p-2 border-e text-left">Training Post Status</th>
...
const fetchAllData = async () => {
  ...
  try {
    ...
    trainings.value = trainingsResponse.data.filter((e) => e.status == 0)
