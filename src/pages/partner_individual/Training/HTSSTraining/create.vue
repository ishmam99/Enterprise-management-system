        ...
        <div class="flex items-center justify-center gap-5">
          ...
          <div class="relative mb-3 w-1/2">
            ...
            <select
              ...
              class="select select-border w-full rounded-xl border-2 px-3 py-1 leading-[1.6] outline transition-all duration-200 ease-linear focus:border-teal-500"
              required
            >
...
const training = reactive({
  ...
  solution_id: '',
  solution_name: '',
  software_id: '', // Added software_id
  software_name: '', // Added software_name
  training_level: '',
  duration: '',
  course_id: ''
})
...
const createTraining = async () => {
  ...
  if (!training.software_id) { // Updated validation to check software_id
    toast({
      title: 'Error',
  ...
  try {
    const response = await api().post('training-course', {
      ...
      software_id: training.software_id, // Send software ID
      software_name: training.software_name, // Send software name
    ...
    training.solution_name = ''
    training.software_id = '' // Reset software ID
    training.software_name = '' // Reset software name
