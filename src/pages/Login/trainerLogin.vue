    ...
    <path
        ...
        :fill="activeLoginType === 'trainer' ? '#FF66A5' : '#A054FF'"
        stroke="#ffffff40"
        stroke-width="1"
        @click="selectLoginType('trainer')"
    />
    <!-- <path
    ...
    <defs>
        <path  id="trainerPath" d="M210,60 A160,160 0 0,1 360,250"   />
        <!-- <path id="partnerPath" d="M80,230 A160,160 0 0,0 390,270"  /> -->
        <!-- <path id="customerPath" d="M80,250 A160,160 0 0,1 210,60"  /> -->
    </defs>

    <text  fill="white" font-size="18" font-weight="600" @click="selectLoginType('trainer')">
        <textPath href="#trainerPath" startOffset="45%">Trainer Login</textPath>
    </text>
