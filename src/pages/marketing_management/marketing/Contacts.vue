  ...
  <div class="min-h-screen w-4/5 bg-gray-50 p-6">
    <div class="max-w-7xl mx-auto">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Contacts</h1>
          <p class="text-gray-500 text-sm mt-1">Manage contacts from marketing campaigns and activities</p>
        </div>
      ...
      <div class="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm mb-6">
        <div class="flex flex-wrap gap-3 items-end">
          ...
          <div>
            ...
            <input type="text" placeholder="Search contacts..." class="bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-lg px-3 py-2 w-48 focus:ring-2 focus:ring-purple-500 focus:border-transparent">
          </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm text-center">
          ...
          <p class="text-xs text-gray-400">Campaigns Engaged</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-100">
              <tr v-for="contact in contacts" :key="contact.id" class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4"><span class="text-sm text-gray-600">{{ contact.email }}</span></td>
                <td class="px-6 py-4">
                  <span class="text-xs px-2 py-1 rounded-full" :class="getSourceClass(contact.source)">{{ contact.source }}</span>
                </td>
                <td class="px-6 py-4">
                  <span class="text-xs px-2 py-1 rounded-full" :class="getStatusClass(contact.status)">{{ contact.status }}</span>
                </td>
                <td class="px-6 py-4"><span class="text-sm text-gray-600">{{ contact.lastActivity }}</span></td>
        ...
        <div class="px-6 py-3 border-t border-gray-100 flex items-center justify-between">
          <p class="text-sm text-gray-500">Showing 1-5 of 24 contacts</p>
...
const contacts = ref([
  { id: 1, name: 'Robert Chen', email: 'robert.chen@boeing.com', source: 'Email Campaign', status: 'Active', lastActivity: 'Oct 15, 2026', avatar: 'https://i.pravatar.cc/100?img=1' },
  { id: 2, name: 'Maria Rodriguez', email: 'maria.rodriguez@lm.com', source: 'Social Media', status: 'Active', lastActivity: 'Oct 14, 2026', avatar: 'https://i.pravatar.cc/100?img=2' },
  { id: 3, name: 'James Wilson', email: 'james.wilson@spacex.com', source: 'Event', status: 'Inactive', lastActivity: 'Oct 12, 2026', avatar: 'https://i.pravatar.cc/100?img=3' },
  { id: 4, name: 'Anna Schmidt', email: 'anna.schmidt@siemens.com', source: 'Website', status: 'Active', lastActivity: 'Oct 10, 2026', avatar: 'https://i.pravatar.cc/100?img=4' },
  { id: 5, name: 'David Kim', email: 'david.kim@airbus.com', source: 'Referral', status: 'Active', lastActivity: 'Oct 8, 2026', avatar: 'https://i.pravatar.cc/100?img=5' },
  { id: 6, name: 'Lisa Thompson', email: 'lisa.thompson@raytheon.com', source: 'Email Campaign', status: 'Unsubscribed', lastActivity: 'Oct 5, 2026', avatar: 'https://i.pravatar.cc/100?img=6' },
  { id: 7, name: 'Mark Patel', email: 'mark.patel@northrop.com', source: 'Social Media', status: 'Active', lastActivity: 'Oct 3, 2026', avatar: 'https://i.pravatar.cc/100?img=7' }
])

const getSourceClass = (source) => {
  const map = {
    'Email Campaign': 'bg-blue-100 text-blue-700',
