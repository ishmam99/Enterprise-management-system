        ...
        <table class="w-full">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">View/Edit/Approve Initial Report</th>
              ...
              <td class="px-6 py-4">
                <div class="flex items-center gap-2">
                  ...
                  <button
                    ...
                    class="inline-flex items-center gap-1.5 text-gray-600 hover:text-gray-900 text-sm font-medium px-3 py-1.5 hover:bg-gray-100 rounded transition-colors"
                  >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                    </svg>
                    <div v-if="editing == report.id" class="animate-spin">
...
const fetchReports = async () => {
  ...
  try {
    ...
    const { data } = await api().get('/success-team-activity-reports?status=2', {
      params
    })
