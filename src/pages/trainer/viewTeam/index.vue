    ...
    <div class="min-h-screen bg-base-200 p-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between bg-white shadow rounded p-4">
                ...
                <span class="badge px-3 text-white" :class="team.status ? 'badge-success' : 'badge-error'">
            ...
            <div class="flex mt-10 justify-center items-center">
                <div class="card bg-green-100 shadow">
                    <div class="card-body">
                        <h2 class="text-xl font-semibold text-primary mb-3">Customer Representative</h2>

                        <div v-for="m in customerMembers" :key="m.id" class="flex items-center gap-3">
                            <div class="placeholder">
                                <div
                                    class="bg-primary flex justify-center items-center text-white rounded-full p-3 w-12">
            ...
            <div class="flex justify-center items-center">
                <div class="card bg-sky-100 shadow">
                    <div class="card-body">
                        <h2 class="text-xl font-semibold text-primary mb-3">Customer Success Manager</h2>
            ...
            <div class="grid gap-16 grid-cols-3">
                <div v-for="m in htssMembers" :key="m.id" class="card bg-amber-100 shadow">
                    <div class="card-body">
                        <h2 class="text-xl font-semibold text-primary mb-3">
                            {{ m.pivot.role }}
                        </h2>
            ...
            <div class="card hidden bg-blue-50 shadow">
                <div class="card-body space-y-4">
                    <h2 class="text-2xl font-semibold text-blue-600">HTSS Team Members</h2>

                    <div class="grid grid-cols-3 gap-4">
                        <MemberCard v-for="m in htssMembers" :key="m.id" :member="m" />
                    </div>
                </div>
            </div>
            ...
            <div class="card hidden bg-violet-50 shadow">
                <div class="card-body space-y-4">
                    ...
                    <MemberCard v-for="m in partnerMembers" :key="m.id" :member="m" />
                </div>
            </div>
            ...
            <div class="card hidden bg-pink-50 shadow">
                <div class="card-body space-y-4">
                    ...
                    <div class="flex justify-start items-center gap-10">
                        <div class="w-full">
                            <MemberCard class="w-full" v-for="m in customerMembers" :key="m.id" :member="m" />
                        </div>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div v-for="customer in team.company?.customers" :key="customer.id"
...
const formattedDate = computed(() =>
    team.value.created_at ? moment(team.value.created_at).format('MMMM Do YYYY') : ''
)
...
const partnerMembers = computed(
    () => team.value.members?.filter((m) => m.pivot.role.includes('MSC')) || []
)

const customerMembers = computed(
    () => team.value.members?.filter((m) => m.pivot.role.includes('Customer Representative')) || []
)
...
/* API */
const getTeam = async () => {
    // Fetch team data based on authStore.team_id
...
onMounted(() => {
    getTeam()
    watch(() => authStore.team_id, getTeam)
})
</script>
