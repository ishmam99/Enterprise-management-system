<template>
  <div class="min-h-screen overflow-x-auto bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
    <!-- Header -->
    ...
    <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              <thead class="bg-blue-400">
                <tr>
                  <th class="text-left py-4 px-6 font-medium text-gray-700">Member</th>
                  <th class="text-left py-4 px-6 font-medium text-gray-700 hidden lg:table-cell">Email</th>
                  <th class="text-left py-4 px-6 font-medium text-gray-700">Company</th>
      ...
      <div class="lg:w-1/3">
        <div class="bg-blue-100 rounded-xl shadow p-6 sticky top-8">
          <h2 class="text-2xl font-bold text-blue-900 mb-6">Member Details</h2>
