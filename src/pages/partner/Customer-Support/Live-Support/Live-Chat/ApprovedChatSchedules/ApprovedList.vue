          ...
          <div class="p-6 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div class="flex items-center text-sm text-gray-600">
                ...
                <div>
                  <div class="font-medium">{{ getChatFeatures(chat).length }} Features</div>
                  <div class="text-xs">Enabled</div>
                </div>
              </div>
            </div>
          ...
          <div class="p-6 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
            <div class="flex space-x-3">
              ...
              <button
                ...
                class="px-4 py-2 border border-gray-300 text-gray-700 hover:border-blue-400 hover:text-blue-700 rounded-xl font-semibold text-sm transition-all duration-300 flex items-center"
              >
                ...
                <div>
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center p-3 bg-white rounded-lg border">
                      ...
                      <span class="font-medium capitalize">{{ chat.status }}</span>
                    </div>
                    <div class="flex justify-between items-center p-3 bg-white rounded-lg border">
                      <span class="text-sm text-gray-600">Duration</span>
                      <span class="font-medium">{{ chat.duration_minutes || 'Not specified' }} min</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="bg-white rounded-lg p-3 border border-gray-200 text-center">
                      <div class="text-sm font-medium text-gray-600">Reminders</div>
                      <div class="text-lg font-semibold" :class="chat.send_reminders === '1' ? 'text-green-600' : 'text-red-600'">
                        {{ chat.send_reminders === '1' ? 'Enabled' : 'Disabled' }}
                      </div>
                    </div>
                    <div class="bg-white rounded-lg p-3 border border-gray-200 text-center">
...
const featureIcons = {
  'file-sharing': 'M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
  ...
  'moderated': 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z',
  'anonymous': 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'
}
