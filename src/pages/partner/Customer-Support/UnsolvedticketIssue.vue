    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="divide-y divide-gray-100 bg-white">
                <tr
                  ...
                  :key="ticket.id"
                  class="hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 transition-all duration-300 cursor-pointer"
                  :class="{ 'bg-purple-50': selectedTicket?.id === ticket.id }"
                    ...
                    <div v-if="ticket.attachment" class="flex justify-center">
                      <div class="relative group">
                        <img
                          ...
                          alt="Attachment"
                          class="w-12 h-12 object-cover rounded-lg border-2 border-purple-200 group-hover:border-purple-400 transition-all duration-300"
            ...
            <div class="inline-flex flex-col items-center max-w-md">
              <div class="relative mb-6">
                <div class="w-24 h-24 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-full flex items-center justify-center">
                  <i class="ri-checkbox-circle-line text-4xl text-purple-500"></i>
                </div>
              ...
              <p class="mt-2 text-gray-600">No tickets match your current filters</p>
              <button
                @click="clearFilters"
        ...
        <div class="lg:col-span-1">
          <div v-if="selectedTicket" class="bg-white rounded-2xl shadow-xl border border-purple-100 sticky top-8">
            <!-- Header -->
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-6 rounded-t-2xl">
              <div class="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  class="p-2 hover:bg-purple-500 rounded-lg transition-colors"
                >
            ...
            <div class="p-6 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
              ...
              <div>
                <h3 class="text-sm font-semibold text-gray-500 mb-2 flex items-center">
                  <i class="ri-chat-1-line mr-2 text-purple-500"></i>
                  SUBJECT
                </h3>
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  <h3 class="text-sm font-semibold text-gray-500 mb-2 flex items-center">
                    <i class="ri-tag-line mr-2 text-purple-500"></i>
                    TYPE
                  </h3>
                  <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                ...
                <div>
                  <h3 class="text-sm font-semibold text-gray-500 mb-2 flex items-center">
                    <i class="ri-alarm-warning-line mr-2 text-purple-500"></i>
                    PRIORITY
                  </h3>
                  <span
                    :class="[
              ...
              <div v-if="selectedTicket.attachment">
                <h3 class="text-sm font-semibold text-gray-500 mb-2 flex items-center">
                  <i class="ri-attachment-line mr-2 text-purple-500"></i>
                  ATTACHMENT
                </h3>
                <div class="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
                  <img
                    ...
                    alt="Attachment"
                    class="w-12 h-12 object-cover rounded-lg border border-purple-300"
                    @error="handleImageError"
                  />
                  <div class="flex-1">
          ...
          <div v-else class="bg-white rounded-2xl shadow-xl border border-purple-100 p-8 text-center">
            <div class="w-16 h-16 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <i class="ri-ticket-line text-2xl text-purple-500"></i>
            </div>
...
const fetchTickets = async () => {
  ...
  try {
    ...
    const response = await api().get(`customer-support?type=online&status=0&company_id=${store?.companyId}`);
