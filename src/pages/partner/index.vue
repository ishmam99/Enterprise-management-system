<template>
  <div class="w-4/5 mx-auto py-4 px-4">
    <!-- Header Section -->
    <div class="mb-6">
      <div
        class="px-10 pt-8 pb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-r from-cyan-100 via-teal-100 to-cyan-100 rounded-2xl text-cyan-800 shadow-xl"
      >
        <div>
          ...
          <p class="text-indigo-800 mt-1">
            Welcome back,
            <span class="font-medium text-yellow-900 animate-pulse">{{ authStore?.user?.name }}</span>
          </p>
        </div>
        <div class="relative">
          <div
    ...
    <div class="px-10 py-6 mx-auto">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Total Users Card -->
        <div
          class="relative px-5 py-8 rounded-2xl shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-gradient-to-br from-sky-200 to-indigo-100 text-blue-700"
        >
          <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-purple-500/10 rounded-full"></div>
          <div class="absolute bottom-0 left-0 -mb-4 -ml-4 w-16 h-16 bg-purple-500/5 rounded-full"></div>
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-purple-900 text-sm font-medium">Total Users</h3>
              <p class="text-4xl font-bold text-blue-700 mt-1">
                <count-up :end-val="dbStats?.users"></count-up>
              </p>
            </div>
            <div class="p-3 bg-blue-700/80 rounded-xl backdrop-blur-sm">
              <svg
        ...
        <div
          class="relative px-5 py-8 rounded-2xl shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-gradient-to-br from-teal-100 to-cyan-200 text-white"
        >
          <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-cyan-600/10 rounded-full"></div>
          <div class="absolute bottom-0 left-0 -mb-4 -ml-4 w-16 h-16 bg-cyan-500/5 rounded-full"></div>
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-teal-900 text-sm font-medium">Total Training Courses</h3>
              <p class="text-4xl font-bold text-cyan-700 mt-1">
                <count-up :end-val="dbStats?.trainings"></count-up>
              </p>
            </div>
            <div class="p-3 bg-cyan-900/40 rounded-xl backdrop-blur-sm">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7 text-white"
                fill="none"
        ...
        <!-- Total Software Card -->
        <div
          class="relative px-5 py-8 rounded-2xl shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-gradient-to-br from-cyan-200 to-orange-200 text-white"
        >
          <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-amber-700/10 rounded-full"></div>
          <div class="absolute bottom-0 left-0 -mb-4 -ml-4 w-16 h-16 bg-orange-600/5 rounded-full"></div>
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-teal-800 text-sm font-medium">Total Software</h3>
              <p class="text-4xl font-bold text-cyan-800 mt-1">
                <count-up :end-val="dbStats?.softwares"></count-up>
              </p>
            </div>
            <div class="p-3 bg-cyan-900/50 rounded-xl backdrop-blur-sm">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7 text-white"
                fill="none"
          ...
          <div class="mt-4 flex items-center">
            <div class="w-full bg-white rounded-full h-2">
              <div class="bg-cyan-700 h-2 rounded-full" style="width: 45%"></div>
            </div>
          </div>
        </div>
        ...
        <!-- Total Solution Card -->
        <div
          class="relative px-5 py-8 rounded-2xl shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-gradient-to-br from-emerald-100 to-pink-100 text-white"
        >
          <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-pink-800/10 rounded-full"></div>
          <div class="absolute bottom-0 left-0 -mb-4 -ml-4 w-16 h-16 bg-rose-800/5 rounded-full"></div>
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-rose-800 text-sm font-medium">Total Solution</h3>
              <p class="text-4xl font-bold text-pink-900 mt-1">
                <count-up :end-val="dbStats?.solutions"></count-up>
              </p>
            </div>
            <div class="p-3 bg-emerald-600/80 rounded-xl backdrop-blur-sm">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7 text-white"
                fill="none"
          ...
          <div class="mt-4 flex items-center">
            <div class="w-full bg-white rounded-full h-2">
              <div class="bg-emerald-300 h-2 rounded-full" style="width: 80%"></div>
            </div>
          </div>
        </div>
      </div>
