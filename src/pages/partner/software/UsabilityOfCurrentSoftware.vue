      ...
      <div class="p-6">
        ...
        <div class="mb-6 flex flex-col sm:flex-row gap-4 justify-between">
          <div class="relative flex-1 max-w-md">
            <input v-model="searchQuery" type="text" placeholder="Search by customer or software..."
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="item in paginatedData" :key="item.id" class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4 border-e border-slate-200 whitespace-nowrap">
                  ...
                  <span class="text-xs text-gray-500 mt-1 block">{{ item.usability }}%</span>
                </td>
                ...
                <td class="px-6 py-4 border-e border-slate-200 whitespace-nowrap text-right text-sm font-medium">
                  <button @click="viewDetails(item)" class="text-teal-600 hover:text-teal-900 mr-3"
                    title="View details">
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="text-sm">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full"
                    :class="selectedItem.status === '0' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'">
          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center">
                ...
                <div class="text-sm">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full"
                    :class="selectedItem.software?.status === '0' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'">
...
const fetchCustomerSoftware = async () => {
  ...
  try {
    ...
    customerSoftware.value = response.data || []
  } catch (error) {
