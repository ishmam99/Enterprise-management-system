    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
      <div class="bg-gradient-to-r from-teal-700 to-teal-800 text-white px-6 py-4">
        <div class="flex justify-between items-center">
          <h1 class="text-2xl font-semibold">Customer Software Assignments</h1>
      ...
      <div class="p-6">
        ...
        <div v-if="loading" class="text-center py-12">
          ...
          <p class="mt-2 text-gray-500">Loading softwares...</p>
        </div>
              ...
              <tr v-for="item in paginatedData" :key="item.id" class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4 border-e border-slate-200 whitespace-nowrap text-right text-sm font-medium">
                  <button
                    ...
                    class="text-teal-600 flex gap-1 items-center hover:text-teal-900 mr-3"
                    title="View details"
                  >
