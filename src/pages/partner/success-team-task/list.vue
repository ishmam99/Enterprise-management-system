...
const loadTasks = async () => {
  loading.value = true
  try {
    const res = await api().get(`/success-team-tasks?user_id=${authStore.user.id}&where=[{"column":"assigned_to","operator":"!=","value":"${authStore.user.id}"}]&with=solution,software,user,assignedPerson,outputs,successTeam`)
