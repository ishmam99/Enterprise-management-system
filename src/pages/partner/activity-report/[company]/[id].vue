    ...
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">
          Approved Activity Reports for <span class="uppercase text-blue-500">{{ route.params?.company }}</span>
        </h1>
            ...
            >
              ...
              <td class="px-6 py-4">
                <div class="flex items-center gap-2">
                  <router-link
                    :to="{name:'partner-activity-report-id',params:{id:report.id}}"
...
const fetchReports = async () => {
  ...
  try {
    ...
    const { data } = await api().get('/success-team-activity-reports?status=1&success_team_id='+route.params.id, {
      params
    })
