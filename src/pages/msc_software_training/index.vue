<template>
  <div class="min-h-screen bg-white">
    ...
    <div>
        ...
        <div class="text-center mb-16">
          <div class="inline-flex items-center gap-2 bg-purple-100 border border-purple-300 rounded-full px-6 py-3 mb-4">
            <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"></path>
            </svg>
            <span class="text-purple-700 font-bold text-sm">FREE WITH EVERY LICENSE PURCHASE</span>
          </div>
          <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mt-2 mb-4">Comprehensive Training Services</h2>
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">Expert-led training programs designed to maximize your team's productivity and software proficiency</p>
        </div>
        
        <!-- Training Types Grid -->
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-6">
          <!-- On-Site Training -->
          <div @click="selectTrainingType('onsite')" class="group bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border-2 border-purple-200 hover:border-purple-400 cursor-pointer">
            <div class="relative h-64 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 overflow-hidden">
              <div class="absolute inset-0 opacity-20">
                <div class="absolute top-0 left-0 w-64 h-64 bg-white rounded-full filter blur-3xl"></div>
                <div class="absolute bottom-0 right-0 w-64 h-64 bg-pink-400 rounded-full filter blur-3xl"></div>
              </div>
              <div class="relative h-full flex flex-col items-center justify-center text-white p-8">
                <div class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mb-6">
                  <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                  </svg>
                </div>
                <h3 class="text-3xl font-bold mb-2">On-Site Training</h3>
                <p class="text-purple-200 text-center">At your location, customized for your team</p>
              </div>
            </div>
            <div class="p-8">
              <ul class="space-y-4">
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Instructor at Your Facility</p><p class="text-gray-600 text-sm">Expert trainers come to your location</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Customized Curriculum</p><p class="text-gray-600 text-sm">Tailored to your specific needs and projects</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Hands-On Practice</p><p class="text-gray-600 text-sm">Real-world examples and exercises</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Flexible Scheduling</p><p class="text-gray-600 text-sm">Training scheduled around your operations</p></div></li>
              </ul>
            </div>
          </div>

          <!-- Online Training -->
          <div @click="selectTrainingType('onsite')" class="group bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border-2 border-blue-200 hover:border-blue-400 cursor-pointer">
            <div class="relative h-64 bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-800 overflow-hidden">
              <div class="absolute inset-0 opacity-20">
                <div class="absolute top-0 left-0 w-64 h-64 bg-white rounded-full filter blur-3xl"></div>
                <div class="absolute bottom-0 right-0 w-64 h-64 bg-cyan-400 rounded-full filter blur-3xl"></div>
              </div>
              <div class="relative h-full flex flex-col items-center justify-center text-white p-8">
                <div class="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mb-6">
                  <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-3xl font-bold mb-2">Online Training</h3>
                <p class="text-blue-200 text-center">Live virtual sessions from anywhere in the world</p>
              </div>
            </div>
            <div class="p-8">
              <ul class="space-y-4">
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Live Interactive Sessions</p><p class="text-gray-600 text-sm">Real-time Q&A with expert instructors</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Screen Sharing & Remote Access</p><p class="text-gray-600 text-sm">Direct collaboration and problem-solving</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Recorded Sessions</p><p class="text-gray-600 text-sm">Access recordings for future reference</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Global Time Zones</p><p class="text-gray-600 text-sm">Convenient scheduling for any location</p></div></li>
              </ul>
            </div>
          </div>

          <!-- Lunch & Learn / Webinars -->
          <div @click="selectTrainingType('online')" class="group bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border-2 border-green-200 hover:border-green-400 cursor-pointer">
            <div class="relative h-64 bg-gradient-to-br from-green-600 via-green-700 to-emerald-800 overflow-hidden">
              <div class="absolute inset-0 opacity-20">
                <div class="absolute top-0 left-0 w-64 h-64 bg-white rounded-full filter blur-3xl"></div>
              ...
              <div class="relative h-full flex flex-col items-center justify-center text-white p-8">
                ...
                <h3 class="text-3xl font-bold mb-2">Lunch & Learn</h3>
                <p class="text-green-200 text-center">Regular online sessions on latest MSC features</p>
              </div>
            </div>
            <div class="p-8">
              <ul class="space-y-4">
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Monthly Live Sessions</p><p class="text-gray-600 text-sm">Regular updates on MSC software features</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Expert Demonstrations</p><p class="text-gray-600 text-sm">Real-world use cases and best practices</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Q&A Sessions</p><p class="text-gray-600 text-sm">Interactive discussions with experts</p></div></li>
                <li class="flex items-start gap-3"><div class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"><svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg></div><div><p class="font-semibold text-gray-900">Free for All Clients</p><p class="text-gray-600 text-sm">Join unlimited webinars at no cost</p></div></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div v-if="selectedTrainingType" ref="softwareSelectionSection" class="mt-2">
          <!-- Back Button -->
          <button @click="goBackToTrainingTypes" class="mb-2 flex items-center gap-2 text-purple-600 hover:text-purple-800 transition font-semibold">
          ...
          <div class="text-center mb-2">
            ...
            <p class="text-lg text-gray-600">Choose by Software or Solution</p>
          </div>
          ...
          <div class="mb-3 w-full">
            ...
            <div class="border-b border-gray-200">
              <nav class="flex justify-between gap-2 -mb-px" aria-label="Course filter tabs">
                <button @click="activeTab = 'solution'" class="w-full flex justify-end" :class="['px-6 py-3 text-sm font-medium rounded-t-lg transition-all duration-200', activeTab == 'solution' ? 'bg-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 hover:text-gray-800']">
                ...
                </button>  <button @click="activeTab = 'software'" class="w-full  " :class="['px-6 py-3 text-sm font-medium rounded-t-lg transition-all duration-200', activeTab == 'software' ? 'bg-purple-600 text-white shadow-md' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 hover:text-gray-800']">
                  <div class="flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                    <span>By Software</span>
                  </div>
                </button>
            ...
            <!-- Tab Panels -->
            <div class="pt-2 p-3" :class="activeTab == 'software' ? 'bg-purple-200' : 'bg-blue-200'">
               <!-- Solution Tab Panel -->
              <div v-show="activeTab == 'solution'" class="transition-all duration-300">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                   <template v-for="solution in analysisTypeList" :key="solution.id" >
                       <div   @click="selectSolution(solution.name)" class="group cursor-pointer bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-gray-200 hover:border-purple-400">
                    <div :class="['h-48 bg-gradient-to-br flex items-center justify-center', solution.gradient]">
                    ...
                    <div class="p-6">
                      ...
                      <div class="flex items-center justify-between">
                        ...
                        <span class="font-bold text-purple-600">{{ getCourseCountForSolution(solution.name) }}</span>
                      </div>
              ...
              <!-- Software Tab Panel -->
              <div v-show="activeTab == 'software'" class="transition-all duration-300">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
  ...
  <div class="grid md:grid-cols-3 gap-6">
    ...
    <div class="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-2xl shadow-lg border border-green-200">
      <div class="sticky top-0 z-10 py-2 mb-2 bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl shadow-md">
        <h1 class="text-center text-2xl font-bol  text-white ">
          🎯 Basic
        </h1>
        <p class="text-center text-sm text-white font-medium">Perfect for those new to the software</p>
      </div>
        <div class="flex justify-center gap-4 items-center mb-2">
          <span class="px-2 py-1 bg-teal-500 text-xs text-white rounded-lg">Linear</span>
          <span class="px-2 py-1 bg-teal-500 text-xs text-white rounded-lg">Non-Linear</span>
          <span class="px-2 py-1 bg-teal-500 text-xs text-white rounded-lg">Explicit</span>
          <span class="px-2 py-1 bg-teal-500 text-xs text-white rounded-lg">Implicit</span>
        </div>
    ...
    <div class="bg-gradient-to-br from-amber-50 to-orange-50 p-4 rounded-2xl shadow-lg border border-amber-200">
      <!-- <div class="sticky top-0 z-10 mb-4">
       ...
       <div class="sticky top-0 z-10 py-2 mb-2 bg-gradient-to-r from-amber-600 to-orange-600 rounded-xl shadow-md">
        <h1 class="text-center text-2xl font-bol  text-white ">
        🚀 Advanced
        </h1>
        <p class="text-center text-sm text-white font-medium">For experienced users seeking mastery</p>
      </div>
        <div class="flex justify-center gap-4 items-center mb-2">
          <span class="px-2 py-1 bg-yellow-500 text-xs text-white rounded-lg">Linear</span>
          <span class="px-2 py-1 bg-yellow-500 text-xs text-white rounded-lg">Non-Linear</span>
          <span class="px-2 py-1 bg-yellow-500 text-xs text-white rounded-lg">Explicit</span>
          <span class="px-2 py-1 bg-yellow-500 text-xs text-white rounded-lg">Implicit</span>
        </div>
    ...
    <div class="bg-gradient-to-br from-red-50 to-rose-50 p-4 rounded-2xl shadow-lg border border-red-200">
      <!-- <div class="sticky top-0 z-10 mb-4">
        ...
        <p class="text-center text-sm text-red-700 mt-2 font-medium">Free weekly webinars on latest features</p>
          ...
          <div class="sticky top-0 z-10 py-2 mb-2 bg-gradient-to-r from-red-600 to-rose-600 rounded-xl shadow-md">
        <h1 class="text-center text-2xl font-bol  text-white ">
          🎓 Lunch & Learn
        </h1>
        <p class="text-center text-sm text-white font-medium">Free weekly webinars on latest features</p>
      </div>
        <div class="flex justify-center gap-4 items-center mb-2">
          <span class="px-2 py-1 bg-pink-500 text-xs text-white rounded-lg">Linear</span>
          <span class="px-2 py-1 bg-pink-500 text-xs text-white rounded-lg">Non-Linear</span>
          <span class="px-2 py-1 bg-pink-500 text-xs text-white rounded-lg">Explicit</span>
          <span class="px-2 py-1 bg-pink-500 text-xs text-white rounded-lg">Implicit</span>
        </div>
      <div class="space-y-4 pr-1 ">
...
import CourseType from '@/components/msc_software_training/course_type.vue'
// == STATE ==
