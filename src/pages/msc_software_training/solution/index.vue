<template>
  <div class="min-h-screen bg-white">
    <!-- Hero Section -->
    <section class="py-2 bg-gradient-to-r from-purple-900 via-purple-800 to-indigo-900 text-white relative overflow-hidden">
    ...
    <section v-else ref="trainingTypesSection" class="py-5 bg-gradient-to-b from-white to-blue-50">
      <div class="container">
        ...
        <div class="mt-2">
          ...
          <div class="text-center mb-2">
            ...
            <p class="text-lg text-gray-600">Choose by  Solution</p>
          </div>
          ...
          <div class="mb-3 w-full">
            ...
            <!-- Tab Panels -->
            <div class="pt-2 p-3 bg-purple-200">
               <!-- Solution Tab Panel -->
          ...
          <div class="flex-1 flex flex-col overflow-hidden p-5">
            ...
            <div class="grid grid-cols-2 gap-2 mb-3 text-xs">
              ...
              <div class="flex items-center gap-1.5">
                ...
                <span class="text-gray-600 truncate"><span class="font-semibold">Software:</span> {{ course.software.name || "Not Available"  }}</span>
              </div>
              ...
              <div class="flex items-center gap-1.5">
                ...
                <span class="text-gray-600 truncate"><span class="font-semibold">Solution:</span> {{ course.solution.name || "Not Available"  }}</span>
              </div>
        ...
        <div class="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-2xl p-8 md:p-12 text-center shadow-2xl border-4 border-yellow-300">
          <div class="flex flex-col md:flex-row items-center justify-center gap-6">
            ...
            <div class="text-white">
              <h3 class="text-3xl md:text-4xl font-bold mb-2"> FREE Training with Every License</h3>
...
const analysisTypeList = ref([
  ...
  { id: "multibody", name: "Multibody Dynamic Analysis", icon: "⚙️", gradient: "bg-gradient-to-br from-pink-600 to-rose-700", shortDescription: "Mechanical system simulation" },
