...
const fetchContacts = async (page = 1) => {
  try {
    ...
    const { data } = await api().get(
      `/crm/modules/3/records?field=c1_315._engineering_segment&value=${encodedType}&page=${page}&per_page=${perPage.value}`
    )
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
          <div class="flex flex-col gap-1">
            ...
            <p class="text-sm text-gray-600">
              Total Contacts <span class="font-semibold"></span>
        ...
        <div v-else class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200 table-zebra">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
              ...
              <tr v-else-if="contacts?.length === 0" class="hover:bg-emerald-50 transition-colors">
              ...
              <tr v-else v-for="(contact, index) in contacts" :key="contact.id"
                ...
                <td v-for="field in fields" :key="field.id"
                  ...
                  <router-link :to="{
                    ...
                    {{contact.values.find((e) => e.field_id == field.id)?.value}}
                  </router-link>
