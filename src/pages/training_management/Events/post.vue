<template>
  <div class="px-2 bg-white py-5 w-11/12 mx-auto">
    <div class="bg-teal-700 rounded-t-2xl text-white px-6 py-4">
      <h1 class="text-2xl font-semibold">Post Training</h1>
      <p class="text-gray-300">Review and post trainings</p>
    </div>
            ...
            >
              ...
              <td class="border border-gray-300 px-4 py-3">
                <div class="flex gap-2">
                  ...
                  >
                    <span v-if="actionLoading && postingId === training.id" class="loading loading-spinner loading-xs"></span>
                    Post
                  </button>
...
const fetchTrainings = async () => {
  ...
  try {
    ...
    trainings.value = response.data.data.filter(e => e.status == 1)
