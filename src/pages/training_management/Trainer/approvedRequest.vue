<template>
  <div class="px-6 bg-white py-2 w-11/12 mx-auto">
    <Breadcrumb/>
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-green-600 to-green-700 rounded-t-2xl text-white px-6 py-6 mb-6">
      <h1 class="text-2xl md:text-3xl font-bold mb-2">Approved Trainer Requests</h1>
      <p class="text-green-100">List of approved trainer registrations</p>
    </div>
...
const fetchApplications = async () => {
  loading.value = true
  try {
    const response = await api().get('trainer-request-form?status=1')
