<template>
  <div class="px-2 bg-white py-5 w-11/12 mx-auto">
    <div class="bg-teal-700 rounded-t-2xl text-white px-6 py-4">
      <h1 class="text-2xl font-semibold">Trainer Approvals</h1>
              ...
              <td class="border border-gray-300 px-4 py-3">
                <div class="flex gap-2">
                  ...
                  <button
                    ...
                    :disabled="actionLoading"
                  >
                    <span v-if="actionLoading && editingId === trainer.id" class="loading loading-spinner loading-xs"></span>
                    Edit
                  </button>
