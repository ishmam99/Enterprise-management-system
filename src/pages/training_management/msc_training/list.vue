<template>
  <div class="px-2 bg-white py-5 w-11/12 mx-auto">
    <div class="bg-teal-700 rounded-t-2xl text-white px-6 py-4">
      <h1 class="text-2xl font-semibold">MSC Training List</h1>
      <p class="text-gray-300">Review and manage MSC training programs</p>
    </div>
...
const mockTrainings = ref([
  {
    ...
    description: "Comprehensive leadership training focusing on strategic thinking, team management, and organizational leadership skills for senior managers.",
  ...
  },
  {
    ...
    trainer: "Ms. Emily Rodriguez",
    level: "basic",
    duration: 2,
    participants: 40,
    location: "Multi-purpose Hall",
    description: "Develop essential communication skills including active listening, presentation skills, and interpersonal communication for workplace success.",
  ...
  },
  {
    ...
    trainer: "Mr. David Wilson",
    level: "basic",
    duration: 1,
    participants: 50,
    location: "Virtual Training",
    description: "Essential cybersecurity training covering threat awareness, safe online practices, and company security policies for all employees.",
  ...
  },
  {
    ...
    trainer: "Ms. Jennifer Martinez",
    level: "intermediate",
    duration: 2,
    participants: 35,
    location: "Safety Training Center",
    description: "Comprehensive workplace safety training covering OSHA standards, emergency procedures, and safety protocol implementation.",
