              ...
              >
                ...
                <td class="px-6 py-4">
                  <div class="flex gap-2">
                    ...
                    @click="statusUpdate(application)"
...
const statusUpdate = async (application) => {
  approvingId.value = application.id
  ...
  try {
    ...
    await api().post(
      `trainer-request-form-status-update/${application.id}`,
      payload,
    ...
    Swal.fire({
      title: 'Approved!',
      text: `Trainer request has been approved.`,
      icon: 'success'
    })
