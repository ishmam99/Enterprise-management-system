...
// ✅ Mock data for HTSS
const mockData = [
  { id: 1, title: 'HTSS Training Batch 01', status: 'Pending' },
  { id: 2, title: 'HTSS Training Batch 02', status: 'Pending' },
  { id: 3, title: 'HTSS Workshop - Dhaka', status: 'Ongoing' }
]

// Fetch HTSS trainings
...
const broadcastTraining = async (training) => {
  ...
  // await api().post(`broadcast-training/${training.id}`)
...
<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex items-center justify-between bg-teal-700 text-white p-4 mb-4 rounded-lg">
      <h1 class="text-xl font-bold">HTSS Training Broadcast ({{ trainings.length }})</h1>
    </div>
