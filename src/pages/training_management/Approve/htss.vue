...
const mockData = [
  { id: 1, title: 'HTSS Training Batch 01', status: 'Completed' },
  { id: 2, title: 'HTSS Training Batch 02', status: 'Ongoing' },
  { id: 3, title: 'HTSS Training for New Employees', status: 'Pending' },
  { id: 4, title: 'HTSS Workshop - Dhaka', status: 'Completed' },
  { id: 5, title: 'HTSS Technical Session', status: 'Ongoing' }
]
...
const fetchTrainings = async () => {
  loading.value = true
  try {
    // const { data } = await api().get('get-htss-trainings')
      ...
      <div class="text-left">
        ...
        <div class="bg-gray-100 p-3 rounded">
          <p class="text-sm text-gray-600">
            Here you can display detailed information about this training batch, instructors, schedule, and participants.
          </p>
        </div>
      </div>
    `,
...
<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex items-center justify-between bg-teal-700 text-white p-4 mb-4 rounded-lg">
      <h1 class="text-xl font-bold">HTSS Training List ({{ trainings.length }})</h1>
    </div>
