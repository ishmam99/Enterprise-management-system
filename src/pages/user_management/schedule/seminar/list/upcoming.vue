<template>
  <div class="p-6 w-4/5 bg-gray-50 min-h-screen mx-auto">
    ...
    <div v-if="loading" class="text-center py-10">
      ...
      <p class="mt-2 text-gray-600">Loading seminars...</p>
    </div>
      ...
      <table class="min-w-full text-sm text-gray-700">
        <thead class="bg-emerald-600 text-white text-left">
          <tr>
            ...
            <th class="py-3 border-e px-4">Seminar Title</th>
        ...
        <tbody>
          ...
          <tr v-if="filteredTrainings.length === 0">
            <td colspan="10" class="text-center py-6 text-gray-400">No seminars found</td>
          </tr>
        </tbody>
      </table>
    </div>
