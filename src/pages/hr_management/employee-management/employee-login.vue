<template>
  <div class="p-6 min-h-screen w-4/5 bg-gray-50">
    ...
    <div class="flex flex-col gap-4 mb-6">
      <div
        class="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-2xl shadow-xl p-6 w-full relative overflow-hidden"
      >
          ...
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h1 class="text-3xl font-bold text-white mb-1 drop-shadow-lg">
                Employee Login &amp; Timecard List
              </h1>
              <p class="text-indigo-100 text-sm font-medium">
                View and review all employees' login, logout and timecard logs
              </p>
            </div>
          </div>
    ...
    <div class="overflow-x-auto bg-white rounded-2xl shadow-xl border border-gray-100">
      <table class="min-w-full text-sm text-gray-700">
        <thead class="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-left">
          <tr>
            ...
            <th class="py-4 border-e border-indigo-500 px-6 font-semibold uppercase tracking-wider">Account / Module</th>
        ...
        <tbody>
          ...
          >
            <td class="py-4 border-e px-6 font-medium text-gray-900">
            ...
            <td class="py-4 border-e px-6">
              <div class="flex flex-wrap gap-1">
                <span
                  ...
                  :key="time.id"
                  class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mb-1 bg-blue-50 text-blue-700"
                >
      ...
      <div
        ...
        class="flex flex-col sm:flex-row justify-between items-center px-6 py-4 bg-gray-50 border-t border-gray-100"
      >
