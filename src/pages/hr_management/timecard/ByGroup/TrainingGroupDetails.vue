          ...
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h1 class="text-3xl font-bold text-white mb-1 drop-shadow-lg">
                Training Person Timecard List
              </h1>
              <p class="text-indigo-100 text-sm font-medium">
                View and review training team timecard logs across multiple accounts
              </p>
            </div>
          </div>
      ...
      <table class="min-w-full text-sm text-gray-700">
        <thead class="bg-gradient-to-r from-blue-600 to-purple-600 text-white text-left">
          <tr>
            ...
            <th class="py-4 border-e border-indigo-500 px-6 font-semibold uppercase tracking-wider">Training Rep</th>
