<template>
  <div class="p-8 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <div class="mx-auto mb-10">
      <h1 class="text-4xl font-bold text-indigo-900 mb-3">Interview Schedule</h1>
    ...
    <div class="mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
      <div class="bg-gradient-to-r from-indigo-600 to-blue-600 px-8 py-5">
        <h2 class="text-2xl font-semibold text-white">Candidate Applications for interviews ({{ applications.length }})</h2>
      </div>
...
const getAllApplications = async() => {
  ...
  try {
    ...
    applications.value = data.data.filter(e => e.status == 3);
  } catch(error) {
