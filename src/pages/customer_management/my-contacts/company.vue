  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
    ...
    <header class="mb-8">
      <h1 class="text-3xl md:text-4xl font-bold text-gray-800 flex items-center gap-3">
        ...
        {{ teamData?.company?.name }} Contacts
      </h1>
      <p class="text-gray-500 mt-2">View all your {{ teamData?.company?.name }} contacts</p>
    </header>
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            ...
            <table class="w-full">
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th class="text-left py-4 px-6 font-medium text-gray-500 hidden lg:table-cell">
                    Email
                  </th>
              ...
              <tbody class="divide-y divide-gray-100">
                ...
                >
                  ...
                  <td class="py-4 px-6">
                    <span
                      class="px-3 py-1 rounded-full text-xs text-nowrap font-medium"
          ...
          <div v-if="!loading && filteredContacts.length === 0" class="py-12 text-center">
            ...
            <p class="text-gray-500 mb-6">
              {{ searchQuery ? 'Try adjusting your search' : 'No members in this team yet' }}
            </p>
            <button
              @click="openAddModal"
              ...
              <div v-if="selectedContact.joined_date" class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="text-gray-800 font-medium">
                    {{ formatDate(selectedContact.joined_date) }}
                  </p>
                </div>
              </div>
            </div>
...
const getContacts = async () => {
  try {
    ...
    contacts.value = data.members
      .filter((e) => e.role == 'customer-manager')
      .map((member) => ({
        ...member,
