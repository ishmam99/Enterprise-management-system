<template>
  <div class="container mx-auto p-4">
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-4 rounded-t-2xl shadow-md">
      <h1 class="text-2xl font-semibold">MSC Training Offer</h1>
    </div>
          ...
          <tr v-for="(training, index) in trainings" :key="training.id" class="border-b hover:bg-gray-50">
            ...
            <td class="py-3 px-4 text-center">
              <button
                ...
                class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow-sm transition-all duration-200"
              >
                Offer
              </button>
            </td>
...
const trainings = ref([
  { id: 1, name: 'MSC Leadership Program', duration: '4 Days', trainer: 'Dr. Hasan' },
  { id: 2, name: 'MSC Technical Skills', duration: '3 Days', trainer: 'Ms. Farhana' },
  { id: 3, name: 'MSC Advanced Workshop', duration: '5 Days', trainer: 'Mr. Rafi' }
])
