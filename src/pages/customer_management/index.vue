<template>
  <div class="w-4/5 mx-auto">
    ...
    <div class="mb-6">
      <div
        class="px-10 pt-8 pb-6 m-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-r from-cyan-600 via-teal-600 to-cyan-500 rounded-2xl text-white shadow-xl"
      >
        <div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          ...
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-purple-100 text-sm font-medium">Active Customers</h3>
        ...
        >
          ...
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-teal-100 text-sm font-medium">Inactive Customers</h3>
              <p class="text-4xl font-bold text-white mt-1">
            ...
            <div class="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white" fill="none" 
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                      d="M18.364 5.636l-12.728 12.728M16 7a4 4 0 11-8 0 4 4 0 018 0zm-4 7a6 6 0 00-6 6v1h12v-1a6 6 0 00-6-6z"/>
              </svg>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-amber-100 text-sm font-medium">Solved Issue Tickets</h3>
              <p class="text-4xl font-bold text-white mt-1">
        ...
        >
          ...
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-rose-100 text-sm font-medium">Total Support Requests</h3>
              <p class="text-4xl font-bold text-white mt-1">
      ...
      <div class="pb-8">
        ...
        >
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
            <!-- Add Solution -->
            <router-link
              to="/customer_management/Customer-Support/ticketIssue"
            ...
            <!-- Add Software -->
            <router-link
              to="/customer_management/Customer-Support/Live-Support/Live-Call/NewCallSchedule"
            ...
            >
              ...
              <span class="text-sm font-semibold text-gray-700 group-hover:text-amber-700 z-10"
                >Create Live call Schedule</span
              >
            </router-link>

            <!-- Create Training Course -->
            <router-link
              to="/customer_management/Customer-Support/Live-Support/Live-Chat/NewChatSchedule"
            ...
            >
              ...
              <span class="text-sm font-semibold text-gray-700 group-hover:text-violet-700 z-10"
                >Create Live chat Schedule</span
              >
            </router-link>

            <!-- Add User -->
            <router-link
              to="/customer_management/Customer-Support/onsite/CreateSupportRequest"
...
const fetchDbStats = async () => {
  try {
    const { data } = await api().get('customers/'+authStore.user?.id+'/stats');
    dbStats.value = data;
  } catch (error) {
