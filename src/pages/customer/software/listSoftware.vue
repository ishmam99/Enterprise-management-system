    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
      <div class="bg-gradient-to-r from-teal-700 to-teal-800 text-white px-6 py-4">
        <div class="flex justify-between items-center">
          <h1 class="text-2xl font-semibold">Software List</h1>
          <span class="bg-teal-600 text-xs font-medium px-2.5 py-0.5 rounded-full">
            {{ services.length }} Software
          </span>
        </div>
      </div>
          ...
          >
            <div class="flex items-start justify-between mb-3">
              <div class="flex items-center">
                ...
                <span v-if="!service.editing" class="text-lg font-semibold text-gray-800">{{ service.software?.name }}</span>
                <input
                  v-else
