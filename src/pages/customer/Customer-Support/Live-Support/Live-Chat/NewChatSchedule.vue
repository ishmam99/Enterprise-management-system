          ...
          <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-4">
                ...
                <label class="flex items-center space-x-3">
                  <input
                    v-model="form.autoTranscript"
                    type="checkbox"
                    class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500 border-blue-300"
                  >
                  <span class="text-sm text-gray-700">Generate chat transcript</span>
                </label>
                <label class="flex items-center space-x-3">
                  <input
                    v-model="form.moderatedChat"
                    type="checkbox"
                    class="w-4 h-4 text-purple-600 rounded focus:ring-purple-500 border-purple-300"
                  >
                  <span class="text-sm text-gray-700">Moderated chat (approve messages)</span>
                </label>
              </div>
              <div class="space-y-4">
                <label class="flex items-center space-x-3">
                ...
                <label class="flex items-center space-x-3">
                  <input
                    ...
                    type="checkbox"
                    class="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500 border-indigo-300"
                  >
                  <span class="text-sm text-gray-700">Archive chat after session</span>
                </label>
              </div>
            </div>
          </div>
...
const addParticipant = () => {
  if (newParticipant.value && !form.value.participants.includes(newParticipant.value)) {
    form.value.participants.push(newParticipant.value)
...
const scheduleChat = () => {
  ...
  console.log('Scheduling chat:', form.value)
