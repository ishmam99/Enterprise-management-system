      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 border border-purple-100">
        <form @submit.prevent="scheduleCall" class="space-y-8">
          ...
          <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <label class="flex items-center space-x-3">
                ...
                >
                <span class="text-sm text-gray-700">Allow guest participants</span>
              </label>
              <label class="flex items-center space-x-3">
                <input
                  v-model="form.waitingRoom"
                  type="checkbox"
                  class="w-4 h-4 text-orange-600 rounded focus:ring-orange-500 border-orange-300"
                >
                <span class="text-sm text-gray-700">Enable waiting room</span>
              </label>
            </div>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
            <button
              type="submit"
              class="flex-1 px-6 py-4 bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
            >
...
const scheduleCall = () => {
  ...
  console.log('Scheduling call:', form.value)
