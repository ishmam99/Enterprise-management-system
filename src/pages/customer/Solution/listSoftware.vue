          ...
          >
            <div class="flex items-start justify-between mb-3">
              <div class="flex items-center">
                ...
                <span v-if="!service.editing" class="text-lg font-semibold text-gray-800">{{ service?.solution_name }}</span>
                <input
                  v-else
...
const addService = async () => {
  ...
  try {
    ...
    // ! await api().post('/softwares', data) mia solution page e, software delete korai fheltesen salman bhai! ekta ekat kaj hoilo?
