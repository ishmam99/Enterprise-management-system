  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div class="mb-4 sm:mb-0">
            <h1 class="text-3xl font-bold text-gray-900">Enrollment by Independent Users List</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class=" rounded-xl shadow-lg p-6 border border-gray-200 bg-pink-200">
        ...
        <div class="bg-blue-100 rounded-xl shadow-lg p-6 border border-gray-200">
          <div class="flex items-center">
      ...
      <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <!-- Users List -->
         <div class="min-h-screen bg-purple-100 py-8 px-4">
    <div class="max-w-full mx-auto">
      <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">
        Enrollment by Independent Users List
      </h1>
