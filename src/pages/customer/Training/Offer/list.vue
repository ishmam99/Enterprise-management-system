<template>
  <div class="px-10 bg-white py-5 w-11/12 mx-auto">
    <div class="bg-teal-700 rounded-t-2xl text-white px-6 py-4">
      <h1 class="text-2xl font-semibold">Our Company Offer List</h1>
        ...
        <table class="table table-auto w-full border-collapse border border-gray-200">
          ...
          <tbody>
            ...
            >
                ...
                <span
                  ...
                  :class="{
                    ...
                    'bg-indigo-100 text-indigo-800':
                      offer.trainingEvent.training_type === 'conference'
                  }"
                >
                  {{ offer.trainingEvent.training_type }}
                </span>
              </td>
              ...
              <td class="border border-gray-300 px-4 py-3">
                <span
                  class="px-2 py-1 rounded-full text-xs font-medium capitalize bg-teal-100 text-teal-800"
                >
                  {{ offer.trainingEvent.platform }}
                </span>
              </td>

              <!-- Industry -->
              <td class="border border-gray-300 px-4 py-3 text-gray-600">
                {{ getIndustryName(offer.industry_id) }}
              </td>

              <!-- Solution -->
              <td class="border border-gray-300 px-4 py-3 text-gray-600">
                {{ getSolutionName(offer.solution_id) }}
              </td>

              <!-- Software -->
              <td class="border border-gray-300 px-4 py-3 text-gray-600">
                {{ getSoftwareName(offer.software_id) }}
              </td>

              <!-- Training -->
              <td class="border border-gray-300 px-4 py-3">
                <div class="font-medium text-gray-900 text-sm">
                  {{ getTrainingTitle(offer.training_id) }}
                </div>
              ...
              <td class="border border-gray-300 px-4 py-3">
                <div class="flex gap-2">
                  ...
                  <router-link
                    :to="{ name: 'customer-Training-Offer-id', params: { id: offer.id } }"
