...
const fetchLeads = async (page = 1) => {
  try {
    ...
    let apiUrl = `/crm/record-child-get/0/Accounts-Deals?per_page=${perPage.value}&page=${page}&filters[d0_001._software_name]=${getApiVariable(route.params.id)}&company_id=${authStore.companyId}`
    ...
    <div class="container mx-auto">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-6">
        <h2 class="text-2xl font-bold text-gray-800 pb-2"> {{
          route.params.id }} Deals - {{ authStore.companyName }}
        </h2>
        <!-- Header controls -->
          ...
          <table class="min-w-full divide-y divide-gray-200 table-zebra">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
              <tr v-if="isLoading" class="hover:bg-emerald-50 transition-colors">
                <td colspan="16" class="px-6  text-center text-gray-500">
              ...
              <tr v-else-if="leads.length === 0" class="hover:bg-emerald-50 transition-colors">
                <td colspan="16" class="px-2  text-center text-gray-500">
