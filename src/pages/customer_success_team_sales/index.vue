      ...
      >
        <div>
          ...
          <p class="text-indigo-100 mt-1">
            Welcome back,
            <span class="font-medium text-yellow-300 animate-pulse">{{ authStore?.user.name }}</span>
          </p>
        </div>
        <div class="relative">
          <div
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          ...
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-purple-100 text-sm font-medium">My Tasks</h3>
        ...
        >
          ...
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-teal-100 text-sm font-medium">My Actions</h3>
              <p class="text-4xl font-bold text-white mt-1">
        ...
        >
          ...
          <div class="flex items-start justify-between relative z-10">
            <div>
              <h3 class="text-amber-100 text-sm font-medium">My Contacts</h3>
              <p class="text-4xl font-bold text-white mt-1">
...
import { useCustomerSuccessTeamSalesStore } from './stores/customerSuccessTeamSalesStore';
