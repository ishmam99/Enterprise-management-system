    ...
    <div class="px-6 py-6 bg-slate-100 min-h-screen">
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800">
                Meeting Schedules for {{ getPeriodTitle() }}
            </h1>
                ...
                <table class="table w-full">
                    ...
                    <tbody>
                        <tr v-for="meeting in meetings" :key="meeting.id"
                            :class="{ 'bg-red-100': isUserInMeeting(meeting) }">
                            ...
                            <td class="border-e">
                                <div class="flex -space-x-2">
                                    <div v-for="user in meeting.users" :key="user.id"
                                        ...
                                        @click="showParticipantName(user.name)">
...
const getDateRange = (period) => {
    ...
    switch (period) {
        ...
        case 'this-weeks-scheduled-meeting':
        ...
        case 'this-months-scheduled-meeting':
            // First day of month
            startDate.setDate(1)
            // Last day of month
        ...
        case 'this-quarters-scheduled-meeting':
        ...
        case 'this-years-scheduled-meeting':
            // First day of year
...
const getPeriodTitle = () => {
    const period = route.params.id
    switch (period) {
        case 'todays-scheduled-meeting': return 'Today'
        case 'this-weeks-scheduled-meeting': return 'This Week'
        case 'this-months-scheduled-meeting': return 'This Month'
        case 'this-quarters-scheduled-meeting': return 'This Quarter'
        case 'this-years-scheduled-meeting': return 'This Year'
...
const getMeetings = async () => {
    ...
    try {
        ...
        const { data } = await api().get(`/meeting-schedules`, {
            params: {
