  ...
  <div class="create-supplier">
    ...
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p class="text-gray-600">Add a new supplier to your system</p>
      </div>
      <NuxtLink
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                <label for="supplier-tier" class="block text-sm font-medium text-gray-700 mb-1">Supplier Tier *</label>
                <select
                ...
                >
                  ...
                  <option value="1">Tier 1 (Direct Manufacturer)</option>
                  <option value="2">Tier 2 (Distributor/Wholesaler)</option>
                  <option value="3">Tier 3 (Reseller/Retailer)</option>
                </select>
              </div>
            </div>
...
const submitSupplier = async () => {
  try {
    ...
    setTimeout(() => {
      navigateTo('/admin/supply_chain_management/suppliers')
    }, 1500)
