...
const fetchLeads = async (page=1) => {
  try {
    isLoading.value = true
        ...
        const { data } = await api().get(`/crm/modules/9/records?page=${page}&per_page=${perPage.value}`)
    ...
    <div class="container mx-auto">
      ...
      <div v-else class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200 table-zebra">
            <thead class="bg-gradient-to-r from-emerald-50 to-teal-50">
              <tr>
                ...
                <th
                  v-for="field in fields.filter(f => f.name !== 'account_id')"
                  :key="field.id"
            ...
            <tbody class="bg-white divide-y divide-gray-100">
              ...
              >
                ...
                >
                  <router-link
                    :to="{
                      name: 'sales_management-proposal-proposalDetails-id',
                      params: { id: lead.id },
        ...
        <div class="flex justify-between items-center mt-6">
            ...
            Showing page <span class="font-semibold">{{ currentPage }}</span> of <span class="font-semibold">{{ totalPages }}  ||  Total Proposals {{ totalAccounts }}</span>
          </p>
