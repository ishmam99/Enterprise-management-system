...
const fetchDeals = async (page = 1) => {
  try {
    ...
    const { data } = await api().get(
      `/crm/modules/5/records?filters[deal_originated_by][]=1. MSC&filters[deal_originated_by][]=1a. MSC-Hexagon&filters[deal_originated_by][]=1b. MSC-Cadence&filters[c1_315._engineering_segment][]=${encodedType}&page=${page}&per_page=${perPage.value}`
    )
    // ?filters[deal_originated_by]=1. MSC&filters[deal_originated_by]=1a. MSC-Hexagon&filters[deal_originated_by]=1b. MSC-Cadence&filters[c1_315._engineering_segment]=${encodedType}&page=${page}&per_page=${perPage.value}
