...
const mockData = [
  ...
  { id: 5, industry_name: 'E-Commerce & Retail', status: 'approved' },
  { id: 6, industry_name: 'Manufacturing & Engineering', status: 'approved' },
  { id: 7, industry_name: 'Real Estate & Construction', status: 'approved' },
  { id: 8, industry_name: 'Hospitality & Tourism', status: 'approved' }
]
...
<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex items-center justify-between bg-teal-700 text-white p-4 mb-4 rounded-lg">
      <h1 class="text-xl font-bold">Approved Industries ({{ industries.length }})</h1>
    </div>
