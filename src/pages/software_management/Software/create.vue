...
const createSkill = async () => {
  ...
  try {
    ...
    const response = await api().post("softwares", { name: skillName.value });
  ...
  <div class="min-h-screen w-4/5 bg-gray-50 py-8 px-4">
    <div class="mx-auto">
      ...
      <div class="flex items-center justify-between mb-8 bg-teal-700 text-white px-6 py-4 rounded-lg">
        <h1 class="text-2xl font-semibold">Create Software</h1>
          ...
          <div class="form-control">
            <label class="label">
              <span class="label-text font-semibold">
                Software Name <span class="text-error">*</span>
              </span>
            </label>
            <input
              type="text"
