...
const mockData = [
  ...
  { id: 4, industry_name: 'Education & E-Learning', status: 'broadcasted' },
  { id: 5, industry_name: 'E-Commerce & Retail', status: 'broadcasted' },
  { id: 6, industry_name: 'Manufacturing & Engineering', status: 'broadcasted' },
...
<template>
  <div class="container mx-auto p-4">
    ...
    <div class="flex items-center justify-between bg-teal-700 text-white p-4 mb-4 rounded-lg">
      <h1 class="text-xl font-bold">Broadcasted Industries ({{ industries.length }})</h1>
    </div>
