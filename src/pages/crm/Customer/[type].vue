...
const buildApiUrl = () => {
  ...
  if (
    ['today', 'thisWeek', 'nextWeek', 'lastWeek', 'thisMonth', 'nextMonth', 'lastMonth'].includes(
      type
    )
  ) {
  ...
  // 2. LEAD STATUS (lead_to_prospect_to_potential)
    ...
    ['initialLead', 'prospect', 'potentialNominee', 'potential', 'highlyPotential'].includes(type)
  ) {
    const statusMap = {
    ...
    <div class="container mx-auto">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
          <h2 class="text-2xl font-bold text-gray-800 capitalize">Accounts - {{ formattedType }}</h2>
                ...
                <td :colspan="fields.length + 1" class="px-6 py-12 text-center text-gray-500">
                  <div class="flex flex-col items-center gap-4">
                    ...
                    <div class="text-center">
                      ...
                      <p class="text-gray-500 mb-4">Try adjusting filters or create a new account</p>
                      <router-link
