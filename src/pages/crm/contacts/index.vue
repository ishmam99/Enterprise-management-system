...
const submitImport = async () => {
  ...
  try {
    ...
    await api().post('/crm/modules/3/import/excel', formData)
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
          ...
          <div class="flex items-center gap-3">
            ...
            <select
              id="perPage"
              v-model="perPage"
              class="border rounded-lg px-8 py-1 text-sm focus:ring-2 focus:ring-yellow-500 focus:outline-none"
            >
          ...
          <button @click="openImportModal" class=" bg-cyan-600 rounded text-sm px-2 btn-sm py-1 font-semibold hover:bg-cyan-700 text-white">
                Import from Excel
              </button>
        </div>
        ...
        >
          <div class="bg-white w-full max-w-md rounded-xl shadow-2xl animate-fadeIn">
            ...
            <div class="px-6 py-4 border-b flex justify-between items-center">
              <h2 class="text-xl font-semibold text-gray-800">Import Contacts from Excel File</h2>
      ...
      <div v-else class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200 table-zebra">
            <thead class="bg-gradient-to-r from-emerald-50 to-teal-50">
              <tr>
                <th
                  class="px-6 py-2 border-x text-left text-xs font-bold text-emerald-700 uppercase tracking-wider"
                >
                 #
                </th>
                <th
            ...
            <tbody class="bg-white divide-y divide-gray-100">
              ...
              >
                ...
                >
                  <router-link
                    :to="{
                      name: 'crm-contacts-contactDetails-id',
                      params: { id: lead.id },
