    ...
    <div class="overflow-x-auto">
      <table class="w-full">
        <thead>
          <tr class="bg-gradient-to-r from-gray-50 to-gray-100">
            ...
            <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">
              {{ authStore.role === 'partner' ? 'Task Team' : 'Task Type' }}
            </th>
        ...
        <tbody class="divide-y divide-gray-100">
          <tr v-for="(task, index) in assignments" :key="task.id" class="hover:bg-gray-50 transition-colors"
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div class="text-xs text-gray-500">{{ task.user?.role || '—' }}</div>
                </div>
              </div>
            </td>
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                ...
                <span class="font-medium text-gray-700">{{ authStore.role == 'partner' ? getTeamName(task.type) :
                  task.type }}</span>
              </div>
            </td>
            <td class="px-6 py-4">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                <button
                  ...
                  title="View" @click="$emit('view-details', task.id)">
                ...
                <button
                  ...
                  title="Edit" @click="$emit('edit-task', task.id)">
                ...
                <button
                  ...
                  title="Delete" @click="$emit('delete-task', task.id, task.solution?.name)">
