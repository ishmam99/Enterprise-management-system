...
<template>
  <div class="rounded-2xl bg-white p-8 shadow-sm border border-gray-100">
    ...
    <!-- Add New Output Form -->
    <div class="mb-8 p-6 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200">
      <h3 class="text-lg font-semibold text-gray-800 mb-4">Add New Update</h3>
      <div class="space-y-4">
        <textarea
          v-model="newOutput"
          class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none"
          placeholder="Describe your progress or add an update..."
          rows="3"
