  ...
  <div class="bg-gray-800 text-white shadow-md w-full">
    <div class="py-2 px-10 w-full">
      <div class="flex items-center justify-between h-16">
        ...
        <span class="font-semibold text-lg">Media and Marketing Management System</span>
        </div>

        <nav class="hidden md:flex space-x-1">
          <!-- <router-link
            to="/marketing_media_management"
          ...
          <router-link
            to="/marketing_media_management/leads"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
          ...
          <router-link
            to="/marketing_media_management/accounts"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
            <Icon name="material-symbols:leaderboard" class="text-lg" />
          ...
          <router-link
            to="/marketing_media_management/contact"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="text-sm">
            <!-- <p class="font-medium text-lg">Mr. </p> -->
