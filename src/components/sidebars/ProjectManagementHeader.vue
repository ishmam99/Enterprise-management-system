  ...
  <div class="bg-gray-800 text-white shadow-md w-full">
    <div class="py-2 px-10 w-full">
      <div class="flex items-center justify-between h-16">
        ...
        <span class="font-semibold text-lg">Projects Management System</span>
        </div>
        ...
        <nav class="hidden md:flex space-x-1">
          ...
          <router-link
            to="/projects_management/leads"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/projects_management/leads')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
          ...
          <router-link
            to="/projects_management/accounts"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/projects_management/accounts')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
            <Icon name="material-symbols:leaderboard" class="text-lg" />
            <span>Accounts</span>
          ...
          <router-link
            to="/projects_management/contact"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/projects_management/contact')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
          ...
          <router-link
            to="/projects_management/products"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/projects_management/products')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
          ...
          <router-link
            to="/projects_management/deals"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/projects_management/deals')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
            <Icon name="material-symbols:inventory" class="text-lg" />
            <span>Deals</span>
