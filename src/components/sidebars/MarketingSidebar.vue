<template>
  <div class="h-full w-80 bg-sky-100 text-gray-800 overflow-y-auto border-r border-gray-200">
    ...
    <nav class="p-4 space-y-6">
      <!-- Main Navigation -->
      <div v-if="route.name == 'marketing'" class="space-y-2">
      ...
      <div v-if="isSectionActive(contractsSection)" class="space-y-3">
        ...
        <router-link
          ...
          class="flex items-center gap-3 px-4 py-2.5 rounded-md border text-sm transition"
          :class="
            route.path === '/marketing/contracts'
              ? 'bg-blue-50 border-blue-500 text-blue-700 font-medium'
              : 'bg-white border-gray-200 hover:bg-gray-100'
          "
        >
        ...
        <router-link
          to="/marketing/contracts/all"
          class="flex items-center gap-3 px-4 py-2 rounded-md border text-sm transition"
          :class="
            route.path === '/marketing/contracts/all'
              ? 'bg-blue-50 border-blue-500 text-blue-700 font-medium'
              : 'bg-white border-transparent hover:bg-gray-100 text-gray-700'
          "
        >
...
const collapsibleSections = computed(() => [
  {
    ...
    allPath: '/marketing/leads/allLeads',
    subItems: leadAccountSubItems.map((item) => ({
      ...item,
      to: item.to ? `/marketing/leads${item.to}` : undefined
    }))
  },
  {
    key: 'accounts',
    path: '/marketing/accounts',
    allPath: '/marketing/accounts/allAccounts',
    subItems: leadAccountSubItems.map((item) => ({
      ...item,
      to: item.to ? `/marketing/accounts${item.to}` : undefined
    }))
  },
  {
    key: 'customer',
    path: '/marketing/customer',
    allPath: '/marketing/customer/allCustomers',
    subItems: leadAccountSubItems.map((item) => ({
      ...item,
      to: item.to ? `/marketing/customer${item.to}` : undefined
    }))
  },
  {
    key: 'deals',
    path: '/marketing/deals',
    allPath: '/marketing/deals/allDeals',
    subItems: dealsSubItems.value.map((item) => ({
      ...item,
      to: item.to ? `/marketing${item.to}` : undefined
    }))
  },
  {
    key: 'contact',
    path: '/marketing/contact',
    allPath: '/marketing/contact/allContacts',
...
const simpleSections = [
  {
    key: 'proposal',
    path: '/marketing/proposal',
    dashboard: '/marketing/proposal',
    subItems: [
      { to: '/marketing/proposal/allProposal', label: 'All', icon: 'ri-list-check-2' },
      {
        to: '/marketing/proposal/createProposal',
        label: 'Create Proposal',
        icon: 'ri-file-add-line'
      },
      {
        to: '/marketing/proposal/currentWeek',
        label: 'Current Week',
        icon: 'ri-calendar-week-line'
      },
      {
        to: '/marketing/proposal/nextMonth',
        label: 'Next Month',
        icon: 'ri-calendar-next-month-line'
      },
      {
        to: '/marketing/proposal/currentMonth',
        label: 'Current Month',
        icon: 'ri-calendar-month-line'
      },
      {
        to: '/marketing/proposal/currentQuarter',
        label: 'Current Quarter',
        icon: 'ri-calendar-quarter-line'
      },
      {
        to: '/marketing/proposal/nextQuarter',
        label: 'Next Quarter',
        icon: 'ri-calendar-future-line'
      },
      {
        to: '/marketing/proposal/qualificationAll',
  ...
  //   dashboard: '/marketing/projects',
  //   subItems: [
  //     { to: '/marketing/projects/currentDeliverable', label: 'Current Projects Deliverable', icon: 'ri-task-line' },
  //     { to: '/marketing/projects/today', label: 'Today', icon: 'ri-calendar-todo-line' },
  //     { to: '/marketing/projects/currentWeek', label: 'Current Week', icon: 'ri-calendar-week-line' },
  //     { to: '/marketing/projects/currentMonth', label: 'Current Month', icon: 'ri-calendar-month-line' },
  //     { to: '/marketing/projects/currentQuarter', label: 'Current Quarter', icon: 'ri-calendar-quarter-line' },
  //   ],
  // },
      {
    key: 'emailUpdates',
    path: '/marketing/email_updates',
    dashboard: '/marketing/email_updates',
    subItems: [
      {
        to: '/marketing/email_updates',
        label: 'All Email Updates',
        icon: 'ri-file-add-line'
      },

      // {
      //   to: '/marketing/employees/assignedEmployees',
      //   label: 'Assigned Employees',
      //   icon: 'ri-user-line'
      // },
      // {
      //   to: '/marketing/employees/unassignedEmployees',
  ...
  {
    key: 'timecard',
    path: '/marketing/timecard',
    dashboard: '/marketing/timecard',
    subItems: [
      { to: '/marketing/timecard', label: 'My Weekly', icon: 'ri-task-line' },
      // {
      //   to: '/marketing/timecard/myWeekly',
      //   label: 'My Weekly',
      //   icon: 'ri-calendar-todo-line'
      // },
      {
        to: '/marketing/timecard/myMonthly',
        label: 'My Monthly',
        icon: 'ri-calendar-todo-line'
      }
    ]
  },
 {
    ...
    dashboard: '/marketing/employees',
    subItems: [
      {
        to: '/marketing/employees/assignRole',
        label: 'Assign Role',
        icon: 'ri-user-add-line'
      },
      {
        to: '/marketing/employees/allEmployees',
        label: 'All Employees',
        icon: 'ri-user-line'
      },
      // {
    ...
    {
    key: 'onlineDeal',
    path: '/marketing/online_requested_deal',
    dashboard: '/marketing/online_requested_deal',
    subItems: [
      {
        to: '/marketing/online_requested_deal',
...
const contractsSection = { key: 'contract', path: '/marketing/contract' }
const contractTimeLinks = [
  { to: '/marketing/contracts/current', label: 'My Current Contract' },
  { to: '/marketing/contracts/worked', label: 'My Worked Contract' },
  { to: '/marketing/contracts/priority', label: 'My Priority Contract' },
  { to: '/marketing/contracts/important', label: 'My Important Contract' }
]
const industries = [
  { text: 'All', route: '/marketing/contracts/industry/all' },
  { text: 'Aerospace', route: '/marketing/contracts/industry/aerospace' },
  { text: 'Automotive', route: '/marketing/contracts/industry/automotive' },
  { text: 'Consumer', route: '/marketing/contracts/industry/consumer' },
  { text: 'Products', route: '/marketing/contracts/industry/products' },
  { text: 'Defense', route: '/marketing/contracts/industry/defense' },
  { text: 'Electronics', route: '/marketing/contracts/industry/electronics' },
  { text: 'Energy', route: '/marketing/contracts/industry/energy' },
  { text: 'Heavy Equipment', route: '/marketing/contracts/industry/heavy-equipment' },
  { text: 'Machinery', route: '/marketing/contracts/industry/machinery' },
  { text: 'Medical', route: '/marketing/contracts/industry/medical' },
  { text: 'Packaging', route: '/marketing/contracts/industry/packaging' },
  { text: 'Retail', route: '/marketing/contracts/industry/retail' },
  { text: 'Shipbuilding', route: '/marketing/contracts/industry/shipbuilding' }
]
