  ...
  <div class="bg-gray-800 text-white shadow-md w-full">
    <div class="py-2 px-10 w-full">
      <div class="flex items-center justify-between h-16">
        ...
        <span class="font-semibold text-lg">HR Management System</span>
        </div>
        ...
        <nav class="hidden md:flex space-x-1">
          ...
          <router-link
            to="/hr_management/jobs"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/hr_management/jobs')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
          ...
          <router-link
            to="/hr_management/hiring"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/hr_management/hiring')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
            <Icon name="material-symbols:leaderboard" class="text-lg" />
            <span>Hiring</span>
          ...
          <router-link
            ...
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/hr_management/employee')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
          ...
          <router-link
            to="/hr_management/tasks"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/hr_management/tasks')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
          ...
          <router-link
            to="/hr_management/holidays"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/hr_management/holidays')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
            <Icon name="material-symbols:inventory" class="text-lg" />
            <span>Holidays</span>
          ...
          <router-link
            to="/hr_management/contracts"
            class="px-4 py-2 rounded hover:bg-gray-700 transition-colors flex items-center gap-2"
            :class="{'bg-blue-600 hover:bg-blue-700': route?.path.includes('/hr_management/contracts')}"
            exact-active-class="bg-blue-600 hover:bg-blue-700"
          >
            <Icon name="material-symbols:inventory" class="text-lg" />
