...
const fetchLeads = async (page = 1) => {
  try {
    ...
    // https:\/\/api.htss.islamicdigitallane.com\/api\/v1\
    // https:\/\/api.htss.islamicdigitallane.com\/api\/v1\/crm\/record-child-get\/4997\/Accounts-Contacts?page=1

    const { data } = await api().get(`/crm\/record-child-get\/${route.query.recordId}\/Accounts-Deals?page=${perPage.value}`)
    ...
    <div class="container mx-auto">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
          <h2 class="text-2xl font-bold text-gray-800">All Deals</h2>
