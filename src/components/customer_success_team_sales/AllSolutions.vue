<template>
  <div class="p-2 w-full mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
      <div class="bg-gradient-to-r from-blue-700 to-blue-800 text-white px-6 py-2">
        <div class="flex justify-between items-center">
          <h1 class="text-2xl font-semibold">{{ route.query.name }} -  Solution List</h1>
        ...
        <div v-else class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200 table-zebra">
            <thead class="bg-yellow-200 text-black">
              <tr>
                <th scope="col" class="px-6 border-e py-3 text-left text-xs font-medium uppercase tracking-wider">
                  Solution Name
                </th>
                <th scope="col" class="px-6 border-e py-3 text-left text-xs font-medium uppercase tracking-wider">
                  Status
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              >
                <td class="px-6 border-e py-2 whitespace-nowrap">
                ...
                <td class="px-6 border-e py-2 whitespace-nowrap text-sm font-medium">
                  <div class="flex space-x-2">
                    ...
                    <button
                      ...
                      class="text-green-500 hover:text-green-700 transition-colors p-1 rounded hover:bg-green-50"
                      title="Save changes"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const getServices = async () => {
  try {
    const response = await api().get(`/customer-solution?customer_id=${route.query.id}`)
