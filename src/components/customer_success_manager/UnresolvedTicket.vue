        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead>
            <tr class="bg-gradient-to-r from-purple-600 to-blue-600 text-white">
              ...
              <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider">User Email</th>
              <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider">Attachment</th>
          ...
          <tbody class="divide-y divide-gray-100 bg-white">
            <tr v-for="ticket in filteredTickets" :key="ticket.id"
              ...
              <td class="px-4 py-3 text-sm font-semibold text-purple-700">#{{ ticket.id }}</td>
              <td class="px-4 py-3">
              ...
              <td class="px-4 py-3 text-sm text-gray-700">{{ ticket?.customer?.user?.name|| 'N/A' }}</td>
              ...
              <td class="px-4 py-3 text-sm text-gray-700">{{ ticket.end_user.user.email || 'N/A' }}</td>
              <td class="px-4 py-3">
