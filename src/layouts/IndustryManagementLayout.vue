       ...
       <!-- <div class="flex items-center justify-start"> -->
        ...
        <div class="space-y-[-10px]">
         ...
         <div class="flex items-center justify-center w-full gap-4">
          ...
          <h1 class="text-2xl uppercase font-bold text-white px-2 py-2 rounded-lg  bg-sky-700 drop-shadow-md">
...
import Sidebar from '@/components/IndustryManagementSidebar.vue'
import { useIndustryManagementStore } from '@/pages/industry_management/stores/industryManagementStore'
const store = useIndustryManagementStore()
