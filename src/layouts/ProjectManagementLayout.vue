      ...
      >
       <!-- <div class="flex items-center justify-start"> -->
        ...
        <div class="flex rounded-lg p-2  gap-2">
         ...
         <img src="/logo.png" alt="Logo" class="w-24 rounded-md m-auto" />
...
import Sidebar from '@/components/ProjectManagementSidebar.vue'
import { useProjectManagementStore } from '@/pages/project_management/stores/projectManagementStore'
