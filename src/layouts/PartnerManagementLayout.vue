...
import Sidebar from '@/components/sidebars/PartnerManagementSidebar.vue'
...
// )
onMounted(() => {
  if (!['partner-director','partner-manager','partner-vp','partner-executive'].includes(authStore.role)) {
