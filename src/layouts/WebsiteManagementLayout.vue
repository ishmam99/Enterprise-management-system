<template>
  <div>
    <div
      class="h-[80px]  w-full flex justify-between bg-cover bg-no-repeat items-center text-black fixed top-0 z-40 duration-300"
    >
      <div
        class="flex items-center justify-between w-full gap-10 px-10 h-[80px]  bg-gradient-to-r from-slate-800 to-slate-900  text-sm  font-semibold"
      >
       <!-- <div class="flex items-center justify-start"> -->
        ...
        <div class="flex rounded-lg p-2  gap-2">
         ...
         <img src="/public/logo.png" alt="Logo" class="w-24 rounded-md m-auto" />
         ...
         <div class="flex items-center justify-center w-full gap-4">
          ...
          <h1 class="text-2xl uppercase font-bold text-white px-2 rounded-lg  bg-sky-700 drop-shadow-md">
        ...
        <div
         class="hover:bg-red-600 bg-white  text-red-600 hover:text-white px-4 py-3 cursor-pointer rounded-lg"
          @click="router.push('/login/adminLogin')"
...
import Sidebar from '@/components/WebsiteManagementSidebar.vue'
import { useWebsiteManagementStore } from '../pages/website_management/stores/websiteManagementStore'
const store = useWebsiteManagementStore()
...
// )
// onMounted(() => {
//   if (['Member', 'VolunteerUser', 'YouthUser', 'Vendor'].includes(authStore.role)) {
