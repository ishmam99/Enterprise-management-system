        ...
        <div class="flex justify-between w-full items-center">
            ...
            <div class="flex gap-2">
              <div class="flex items-start gap-1">
                ...
                <div class="space-y-[-10px]">
                  <p class="text-white font-bold text-nowrap w-32 shadow-lg text-2xl">Hi-Tech</p>
                  <p class="text-red-700 font-bold text-nowrap w-32 shadow-lg text-3xl">SoftSys</p>
                </div>
              </div>
              <div
                class="text-xl bg-sky-500/30 rounded-e-lg border-s-2 flex items-start flex-col text-nowrap uppercase font-bold text-white px-2 mx-10 drop-shadow-md"
              >
                Software Management
                <span>Dashboard</span>
              </div>
          ...
          <div class="flex items-center justify-center w-full gap-4">
            <div class="flex flex-col gap-1 items-center">
              <span
                class="bg-white text-3xl text-center flex font-bold text-red-600 text-nowrap py-1 px-2 rounded-lg drop-shadow-md"
              >
                <img
          ...
          >
            ...
            <transition name="fade-slide">
              ...
              >
                ...
                <router-link v-for="team in myTeams" :key="team.id" :to="'/software_management'">
                  <div
...
import Sidebar from '@/components/SMSSidebar.vue'
...
onMounted(() => {
  if (
    ![
      'software-director',
      'software-executive',
      'software_management_system_vp',
      'software_management_system_director',
      'software_management_system_manager',
      'software_management_system_executive',
      'software-manager'
